...
namespace csX75{
    ...
    public:
        ...
        void trans_x_inc() {mainbody->inc_tx();};
        void trans_y_inc() {mainbody->inc_ty();};
        void trans_z_inc() {mainbody->inc_tz();};
        void trans_x_dec() {mainbody->dec_tx();};
        void trans_y_dec() {mainbody->dec_ty();};
        void trans_z_dec() {mainbody->dec_tz();};
        
        void hrender() {mainbody->render_tree(this) ;} ;
        void get_all_poses(std::vector<float>&data) {mainbody->get_orientation(data);} ;
        void set_all_poses(std::vector<float>&data) {mainbody->set_orientation(data);} ;
